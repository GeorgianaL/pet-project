...
//     this.setConfigProps(config, data);
//   }
//
//   componentDidMount() {
//     this.renderD3();
...
//       this.setConfigProps(nextProps.config, nextProps.data);
//     }
//     this.renderEntitiesCircle();
//   }
//
//   componentDidUpdate() {
//     this.renderD3();
...
//     const { links, nodes } = this.state.data.toJS();
...
//   }
//
//   renderEntitiesCircle() {
//     const { selectedEntity } = this.props;
//
//     d3.selectAll('[data-id]')
//       .attr('stroke-width', d => (d.id === selectedEntity ? 2 : 0));
//   }
//
//   render() {
//     const { config } = this.state;
